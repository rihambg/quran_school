...
class SubscriptionTypesManagementPage extends StatefulWidget {
  const SubscriptionTypesManagementPage({Key? key}) : super(key: key);
  ...
  @override
  State<SubscriptionTypesManagementPage> createState() =>
      _SubscriptionTypesManagementPageState();
}

class _SubscriptionTypesManagementPageState
    extends State<SubscriptionTypesManagementPage> {
  int _rowsPerPage = 15;
  int _page = 0;
  String _search = '';
  ...
  void _showAddDialog() async {
    final result = await showDialog<List<String>>(
      ...
      builder: (context) => AddSubscriptionDialog(
        typeOptions: SubscriptionTypesManagementPage.typeOptions,
      ),
    );
  ...
  Future<void> _exportToExcel() async {
    ...
    sheet.appendRow(['نوع الاشتراك', 'النوع', 'المبلغ']);
    ...
    if (excelBytes != null) {
      if (kIsWeb) {
        ...
        final anchor = html.AnchorElement(href: url)
          ..setAttribute('download', 'export_subscriptions.xlsx')
          ..click();
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              height: 38,
              decoration: BoxDecoration(
                color: SubscriptionTypesManagementPage.goldColor,
                borderRadius: BorderRadius.circular(7),
              ),
              alignment: Alignment.centerRight,
              padding: const EdgeInsets.symmetric(horizontal: 18),
              child: const Text(
                'الصفحة الرئيسية / الشؤون المالية / إعدادات المالية / إدارة أنواع الاشتراكات',
                style: TextStyle(
                  color: Colors.white,
            ...
            Row(
              children: [
                _TopButton(
                  text: "Excel",
                  color: SubscriptionTypesManagementPage.tealColor,
                      ...
                      child: ConstrainedBox(
                        ...
                        child: DataTable(
                          ...
                          headingRowColor: MaterialStateProperty.all(
                              SubscriptionTypesManagementPage.tealColor),
      ...
      child: DropdownButtonHideUnderline(
        child: DecoratedBox(
          ...
          child: DropdownButton<int>(
            ...
            dropdownColor: SubscriptionTypesManagementPage.tealColor,
...
class EditSubscriptionDialog extends StatefulWidget {
  ...
  const EditSubscriptionDialog(
      {Key? key, required this.initialData, required this.typeOptions})
      : super(key: key);
...
class _EditSubscriptionDialogState extends State<EditSubscriptionDialog> {
  ...
  void initState() {
    ...
    amountController = TextEditingController(text: widget.initialData[2]);
    category = widget.initialData[1];
  }
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.stretch,
                children: [
                  const Text('نوع الاشتراك', textAlign: TextAlign.right),
                  ...
                  const SizedBox(height: 14),
                  const Text('النوع', textAlign: TextAlign.right),
                  const SizedBox(height: 6),
            ...
            Padding(
              ...
              child: ElevatedButton(
                style: ElevatedButton.styleFrom(
                  backgroundColor: SubscriptionTypesManagementPage.tealColor,
                ...
                onPressed: () {
                  ...
                  Navigator.of(context).pop(
                      [typeController.text, category!, amountController.text]);
                },
...
class AddSubscriptionDialog extends StatefulWidget {
  final List<String> typeOptions;
  const AddSubscriptionDialog({Key? key, required this.typeOptions})
      : super(key: key);
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                ...
                image: DecorationImage(
                  image: AssetImage(
                      'assets/pattern.png'), //yet to add the actual pattern
                  fit: BoxFit.cover,
                ),
              ),
              child: Stack(
