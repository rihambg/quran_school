...
class SalaryTypesManagementPage extends StatefulWidget {
  const SalaryTypesManagementPage({Key? key}) : super(key: key);

  static const Color tealColor = Color(0xFF19A598);
  static const Color goldColor = Color(0xFFBE9656);

  @override
  State<SalaryTypesManagementPage> createState() =>
      _SalaryTypesManagementPageState();
}

class _SalaryTypesManagementPageState extends State<SalaryTypesManagementPage> {
  int _rowsPerPage = 15;
  int _page = 0;
  String _search = '';
  ...
  void initState() {
    super.initState();
    allRows = [
      ["امتياز شهري", "شهري", "المعلمين", "5000"],
      ["راتب معلم ساعي", "باستمرار", "المعلمين", "1000"],
    ];
  ...
  void _showAddDialog() async {
    final result = await showDialog<List<String>>(
      context: context,
      builder: (context) => AddSalaryTypeDialog(),
    );
  ...
  Future<void> _exportToExcel() async {
    ...
    sheet.appendRow(['نوع الراتب', 'النوع', 'الفئة', 'المبلغ']);
    ...
    if (excelBytes != null) {
      if (kIsWeb) {
        ...
        final anchor = html.AnchorElement(href: url)
          ..setAttribute('download', 'salary_types.xlsx')
          ..click();
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  height: 38,
                  decoration: BoxDecoration(
                    color: SalaryTypesManagementPage.goldColor,
                    borderRadius: BorderRadius.circular(7),
                  ),
                  alignment: Alignment.centerRight,
                  padding: const EdgeInsets.symmetric(horizontal: 18),
                  child: const Text(
                    'الصفحة الرئيسية / الشؤون المالية / إعدادات المالية / إدارة أنواع الرواتب',
                    style: TextStyle(
                      color: Colors.white,
                ...
                Row(
                  children: [
                    _TopButton(
                      text: "Excel",
                      color: SalaryTypesManagementPage.tealColor,
                          ...
                          child: ConstrainedBox(
                            ...
                            child: DataTable(
                              ...
                              headingRowColor: MaterialStateProperty.all(
                                  SalaryTypesManagementPage.tealColor),
                              dataRowColor:
                              ...
                              columns: const [
                                DataColumn(label: Text('نوع الراتب')),
                                ...
                                (i) {
                                  ...
                                  return DataRow(
                                    ...
                                    cells: [
                                      ...
                                      DataCell(Text(pagedRows[i][2])),
                                      DataCell(Text(pagedRows[i][3])),
                                      DataCell(
                                        Checkbox(
        ...
        style: ElevatedButton.styleFrom(
          ...
          shape: RoundedRectangleBorder(
            ...
            side: buttonColor == Colors.white
                ? const BorderSide(
                    color: SalaryTypesManagementPage.tealColor, width: 1.6)
                : BorderSide.none,
          ),
      ...
      child: DropdownButtonHideUnderline(
        child: DecoratedBox(
          ...
          child: DropdownButton<int>(
            ...
            dropdownColor: SalaryTypesManagementPage.tealColor,
...
class AddSalaryTypeDialog extends StatefulWidget {
  const AddSalaryTypeDialog({Key? key}) : super(key: key);

  @override
  State<AddSalaryTypeDialog> createState() => _AddSalaryTypeDialogState();
}

class _AddSalaryTypeDialogState extends State<AddSalaryTypeDialog> {
  final TextEditingController titleController = TextEditingController();
  final TextEditingController titleForeignController = TextEditingController();
  String? selectedType;
  String? selectedCategory;
  final TextEditingController amountController = TextEditingController();

  final List<String> types = ['شهري', 'باستمرار'];
  final List<String> categories = ['المعلمين', 'الإداريين', 'الطلاب'];

  @override
  void dispose() {
    titleController.dispose();
    titleForeignController.dispose();
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Align(
                    alignment: Alignment.centerRight,
                    child: Text(' : عنوان الراتب بالأجنبي',
                        style: const TextStyle(
                            fontWeight: FontWeight.bold, fontSize: 15)),
                  ),
                  const SizedBox(height: 6),
                  TextField(
                    controller: titleForeignController,
                    decoration: InputDecoration(
                      hintText: "",
                      border: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(7),
            ...
            Padding(
              ...
              child: ElevatedButton(
                style: ElevatedButton.styleFrom(
                  backgroundColor: SalaryTypesManagementPage.tealColor,
